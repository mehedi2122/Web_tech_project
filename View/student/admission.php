...
function validateForm() {
    ...
    let username = document.forms["admissionForm"]["username"].value.trim();
    let password = document.forms["admissionForm"]["password"].value.trim();
    let course = document.forms["admissionForm"]["course"].value;
